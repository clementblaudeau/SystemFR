...
Proof.
  unfold open_equivalent; intros; eapply_any; steps; eauto using satisfies_expand_vars.
Qed.
...
Lemma open_reducible_expand_vars_context:
  forall Θ Γ1 Γ2 x y p t T u v,
    ...
    [ Θ; Γ1 ++ (x, open 0 (close 0 T y) t) :: Γ2 ⊨ u : v ].
Proof.
  unfold open_reducible; intros ; eapply_any; steps; eauto using satisfies_expand_vars.
Qed.
...
Lemma open_subtype_expand_vars_context:
  forall Θ Γ1 Γ2 x y p t T u v,
    ...
    [ Θ; Γ1 ++ (x, open 0 (close 0 T y) t) :: Γ2 ⊨ u <: v ].
Proof.
  unfold open_subtype ; intros ; eapply_any; steps; eauto using satisfies_expand_vars.
Qed.
